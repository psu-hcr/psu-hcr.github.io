...
apt-get update
apt-get upgrade
git clone https://github.com/psu-hcr/psu-hcr.github.io
```
This will update and upgrade your system, and then create a new folder on your device containing the latest version of the website. The new folder will be named `psu-hcr.github.io`.   

2. Next, navigate to this new folder and install `bundler`
```
cd ~/psu-hcr.github.io
...
5. To make sure it's working, open `psu-hcr.github.io/people/YOURNAME` using your favorite text editor and change YOUR NAME in line 5 to say something else. Save the file and refresh `http://127.0.0.1:4000/people/YOURNAME`. You should see the header of the page change.
